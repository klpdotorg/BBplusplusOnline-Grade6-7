Game.NSF_MLP_01_G7Score=function(game){

};

Game.NSF_MLP_01_G7Score.prototype={
	create:function(game){
		
        console.log("inside NSF_MLP_01_G7Score js" );
		_this = this;
		...
		_this.nextBtn.events.onInputDown.add(function()
		{
            ...
            //_this.clickSound.play();
			//_this.cache.destroy();
			_this.state.start('NSF_MLP_01_G7level1',true,false); 
		},_this);
