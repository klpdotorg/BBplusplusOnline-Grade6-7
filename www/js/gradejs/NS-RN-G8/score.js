Game.NS_RN_G8Score=function(game){

};

Game.NS_RN_G8Score.prototype={
	create:function(game){
		
        console.log("inside AL_SORT1_G7Score js" );
		_this = this;
		...
		_this.homeBtn.events.onInputDown.add(function(){
			...
			_this.fplayFlag = 0;
			_this.q_count = 0;
		   _this.state.start('NS_RN_G8level1',true,false); 
        ...
        _this.replay.events.onInputDown.add(function(){ 
			...
			_this.fplayFlag = 0;
			_this.q_count = 0;
			console.log(_this.keepCount,_this.hand_flag,_this.fplayFlag,_this.q_count);
            _this.state.start('NS_RN_G8level1',true,false);
         },_this);
