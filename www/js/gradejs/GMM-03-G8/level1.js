...
Game.GMM_03_G8level1.prototype =
{
        ...
        _this.speakerbtn.events.onInputDown.add(function () {
            ...
            if (_this.speakerbtnClicked == false && _this.rightbtn_Clicked == false) {
                ...
                if (_this.Question_flag == 0) {
                    ...
                    if (_this.languageSelected == "ENG")
                        _this.Ask_Question1 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/ENG/V1.mp3');
                    else if (_this.languageSelected == "HIN") _this.Ask_Question1 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/HIN/V1.mp3');
                    else if (_this.languageSelected == "KAN") _this.Ask_Question1 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/KAN/V1.mp3');
                }
                if (_this.Question_flag == 1) {
                    ...
                    else if (_this.languageSelected == "HIN") _this.Ask_Question2 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/HIN/GMM_03_G8_a1.mp3');
                    else if (_this.languageSelected == "KAN") _this.Ask_Question2 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/KAN/GMM_03_G8_a1.mp3');
                }
                if (_this.Question_flag == 2) {
                    ...
                    else if (_this.languageSelected == "HIN") _this.Ask_Question3 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/HIN/GMM_03_G8_a4.mp3');
                    else if (_this.languageSelected == "KAN") _this.Ask_Question3 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/KAN/GMM_03_G8_a4.mp3');
                }
                if (_this.Question_flag == 3) {
                    ...
                    else if (_this.languageSelected == "HIN") _this.Ask_Question4 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/HIN/GMM_03_G8_a2.mp3');
                    else if (_this.languageSelected == "KAN") _this.Ask_Question4 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/KAN/GMM_03_G8_a2.mp3');
                }
                if (_this.Question_flag == 4) {
                    ...
                    else if (_this.languageSelected == "HIN") _this.Ask_Question5 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/HIN/GMM_03_G8_a5.mp3');
                    else if (_this.languageSelected == "KAN") _this.Ask_Question5 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/KAN/GMM_03_G8_a5.mp3');
                }
                if (_this.Question_flag == 5) {
                    ...
                    else if (_this.languageSelected == "HIN") _this.Ask_Question6 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/HIN/GMM_03_G8_a3.mp3');
                    else if (_this.languageSelected == "KAN") _this.Ask_Question6 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/KAN/GMM_03_G8_a3.mp3');
                }
                if (_this.Question_flag == 6) {
                    ...
                    else if (_this.languageSelected == "HIN") _this.Ask_Question7 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/HIN/GMM_03_G8_a6.mp3');
                    else if (_this.languageSelected == "KAN") _this.Ask_Question7 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/KAN/GMM_03_G8_a6.mp3');
                }
    ...
    firstScreenAnim: function () {
        ...
        if (_this.count1 == 0) {
            ...
            else if (_this.languageSelected == "HIN") _this.Ask_Question1 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/HIN/GMM_03_G8_d1.mp3');
            else if (_this.languageSelected == "KAN") _this.Ask_Question1 = _this.playAudio(window.baseUrl + 'questionSounds/GMM-03-G8/KAN/GMM_03_G8_d1.mp3');
        ...
        switch (_this.languageSelected) {
            case 'ENG': _this.time.events.add(5000, function () {
                _this.initialScreenLoad();
                _this.hintBtn.inputEnabled = true;
                _this.hintBtn.input.useHandCursor = true;
                _this.speakerbtn.inputEnabled = true;
                ...
                break;
            case 'HIN': _this.time.events.add(7000, function () {
                _this.initialScreenLoad();
                _this.hintBtn.inputEnabled = true;
                _this.hintBtn.input.useHandCursor = true;
                _this.speakerbtn.inputEnabled = true;
                ...
                break;
            case 'KAN': _this.time.events.add(8000, function () {
                _this.initialScreenLoad();
                _this.hintBtn.inputEnabled = true;
                _this.hintBtn.input.useHandCursor = true;
                _this.speakerbtn.inputEnabled = true;
